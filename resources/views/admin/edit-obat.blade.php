        ...
        <form action="{{ route('obat.update', ['id' => $obat->id]) }}" method="POST">
          ...
          <div class="w-full px-8 my-6 flex flex-col items-center gap-3">
            ...
            <div class="w-full flex flex-col gap-1">
              ...
              <input type="text" name="nama_obat" id="nama_obat" class="block w-full rounded-md" value="{{ $obat->nama_obat }}">
            </div>

            <!-- Satuan -->
            <div class="w-full flex flex-col gap-1">
              <label for="satuan" class="font-semibold">Satuan</label>
              <input type="text" name="satuan" id="satuan" class="block w-full rounded-md" value="{{ $obat->satuan }}">
            </div>

            <!-- Harga -->
            <div class="w-full flex flex-col gap-1">
              <label for="harga" class="font-semibold">Harga</label>
              <input type="number" name="harga" id="harga" class="block w-full rounded-md" value="{{ $obat->harga }}">
            </div>
